...
import { Download, Sparkles, X, Zap, Check, Smartphone } from 'lucide-react';
                            ...
                            >
                                ...
                                {isStandalone ? (
                                    ...
                                    <div className="space-y-3">
                                        <button
                                            onClick={() => {
                                                // Always attempt to trigger it directly exactly as requested
                                                handleInstallClick();

                                                // Wait 500ms before concluding if it failed to show a prompt
                                                setTimeout(() => {
                                                ...
                                                <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="pt-2">
                                                    <div className="p-4 bg-primary/5 rounded-xl border border-primary/10 space-y-2 text-left">
                                                        ...
                                                        <div className="text-[10px] text-muted font-medium leading-relaxed">
                                                            Your browser blocked the automatic popup. Look for the <strong>Install App</strong> or <strong>App Available</strong> icon (small monitor with a down-arrow) in the far right of your browser's URL address bar and click it.
                                                        </div>
                                                    </div>
                                                </motion.div>
                                            )}
